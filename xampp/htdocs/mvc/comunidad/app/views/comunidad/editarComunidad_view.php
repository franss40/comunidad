            ...
            <form action="" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-sm-7">
                        ...
                        <input type="text" name="cod" class="form-control text-end" id="cod" value="<?=$comunidad->cod ?>" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="direccion" class="form-control" id="direccion" value="<?=$comunidad->calle ?>" required>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="poblacion" class="form-control" id="poblacion" value="<?=$comunidad->poblacion ?>" required>
                    </div>
                </div>   
