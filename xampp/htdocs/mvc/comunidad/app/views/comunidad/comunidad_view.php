        ...
        <div class="container">
            <div class="row">
                <div class="info col-md-6 col-lg-5">
                    <p>
                        <strong>Fila Roja</strong> = Comunidad con Cuotas pendientes
                    </p>
                    <p>
                        <img class="ms-2" src="<?= URLROOT . '/public/img/telephone.svg' ?>" width="20" height="20" alt="tiene incidencia abierta" title="Incidencia abierta"/> = Comunidad con incidencia
                    </p>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><br>IMPORTE Y <br> CUOTAS PTES</th>                          
