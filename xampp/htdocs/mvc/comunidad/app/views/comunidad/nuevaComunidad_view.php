            ...
            <form action="" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-sm-7">
                        ...
                        <input type="text" name="cod" class="form-control text-end" id="cod" value="NUEVA COMUNIDAD" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" name="iban" class="form-control" id="iban" maxlength="24">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="codigoPostal" class="form-control" id="codigo" required maxlength="5">
                    </div>
                    <div class="col">
