...
function auth(string $control, string $tipoUsuario = '') {
    ...
    $permisos = array(
        ''          => 0b1,
        'ADMIN'     => 0b111111111111111, // 15 = 1111 significa que permite la función 1,2,3,4
        'OPERARIO'  => 0b111111111111111, // 1101 significa que permite la función 1,2,4
        'USUARIO'   => 0b111111111111111   // 1111
    );
